...
static PyObject*
_wrap_PyNs3DefaultDeleter__Ns3FlowClassifier__tp_richcompare (PyNs3DefaultDeleter__Ns3FlowClassifier *PYBINDGEN_UNUSED(self), PyNs3DefaultDeleter__Ns3FlowClassifier *other, int opid)
{
    
    if (!PyObject_IsInstance((PyObject*) other, (PyObject*) &PyNs3DefaultDeleter__Ns3FlowClassifier_Type)) {
...
PyTypeObject PyNs3DefaultDeleter__Ns3FlowClassifier_Type = {
    ...
    (richcmpfunc)_wrap_PyNs3DefaultDeleter__Ns3FlowClassifier__tp_richcompare,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
...
static PyObject*
_wrap_PyNs3Ipv4FlowClassifierSortByCount__tp_richcompare (PyNs3Ipv4FlowClassifierSortByCount *PYBINDGEN_UNUSED(self), PyNs3Ipv4FlowClassifierSortByCount *other, int opid)
{
    
    if (!PyObject_IsInstance((PyObject*) other, (PyObject*) &PyNs3Ipv4FlowClassifierSortByCount_Type)) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }
    switch (opid)
...
PyTypeObject PyNs3Ipv4FlowClassifierSortByCount_Type = {
    ...
    (traverseproc)NULL,     /* tp_traverse */
    (inquiry)NULL,             /* tp_clear */
    (richcmpfunc)_wrap_PyNs3Ipv4FlowClassifierSortByCount__tp_richcompare,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
...
static PyObject*
_wrap_PyNs3Ipv6FlowClassifierSortByCount__tp_richcompare (PyNs3Ipv6FlowClassifierSortByCount *PYBINDGEN_UNUSED(self), PyNs3Ipv6FlowClassifierSortByCount *other, int opid)
{
    
    if (!PyObject_IsInstance((PyObject*) other, (PyObject*) &PyNs3Ipv6FlowClassifierSortByCount_Type)) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }
    switch (opid)
...
PyTypeObject PyNs3Ipv6FlowClassifierSortByCount_Type = {
    ...
    (traverseproc)NULL,     /* tp_traverse */
    (inquiry)NULL,             /* tp_clear */
    (richcmpfunc)_wrap_PyNs3Ipv6FlowClassifierSortByCount__tp_richcompare,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
...
int _wrap_convert_py2c__std__vector__lt___unsigned_long_long___gt__(PyObject *arg, std::vector< unsigned long long > *container)
{
    if (PyObject_IsInstance(arg, (PyObject*) &Pystd__vector__lt___unsigned_long_long___gt___Type)) {
        *container = *((Pystd__vector__lt___unsigned_long_long___gt__*)arg)->obj;
        ...
        PyErr_SetString(PyExc_TypeError, "parameter must be None, a Std__vector__lt___unsigned_long_long___gt__ instance, or a list of long unsigned int");
        return 0;
    }
    return 1;
}
