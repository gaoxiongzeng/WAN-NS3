...
#define S_TO_R_BW        "10Mbps" // Server to router
#define S_TO_R_DELAY     "10ms"
#define R_TO_C_BW        "10Mbps"  // Router to client (bttlneck)
#define R_TO_C_DELAY     "10ms"
#define ENDHOST_BUFFER   1000000 // should be at least one BDP + buffer_size
#define PACKET_SIZE      1448      // Bytes.
#define SERVER_NUM       3   // n of n-to-1 (incast degree)
...
int main (int argc, char *argv[]) {
  ...
  int buffer_size = 20;
  string trace_file_name = "trace-generator/trace_file/example.trace";
